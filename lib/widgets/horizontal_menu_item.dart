                    ...
                    child: Row(
                      children: [
                       ...
                       SizedBox(width:_width / 88),
                        ...
                        Flexible(child: CustomText(text: itemName , color: menuController.isHovering(itemName) ? Colors.pink : lightGrey,))
                        else
                        Flexible(child: CustomText(text: itemName , color:  Colors.pink , size: 18, weight: FontWeight.bold,))
